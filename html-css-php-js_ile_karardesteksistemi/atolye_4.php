...
WHERE maas_tablosu.calisan_id=calisanlar.calisan_id AND calisanlar.atolye_id=atolyeler.atolye_id and calisanlar.bolum_id=bolum.bolum_id AND calisanlar.atolye_id=3
GROUP BY maas_tablosu.maas_yili";
    $mbsonuc=mysqli_query($baglanti,$mbtablosu);

$stur='SELECT (sum(stoktaki_urunler.stokta_kalan_sayi)/sum(atolye_urun.uretilen_sayi))*100 as sayı, atolye_urun.yil as yil FROM atolye_urun, stoktaki_urunler, atolyeler WHERE atolyeler.atolye_id=atolye_urun.atolye_id AND atolyeler.atolye_id=4 GROUP BY atolye_urun.yil';
...
WHERE atolye_urun.yil=2020 AND atolye_urun.atolye_id=4
...
WHERE atolye_urun.urun_id=urun.urun_id and atolye_urun.atolye_id=atolyeler.atolye_id and atolyeler.atolye_id= 4
...
WHERE atolye_makine.makine_id=makineler.makine_id AND atolye_makine.atolye_id=4";
